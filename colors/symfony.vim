...
" robertr changes: bg color 235->233
...
highlight Normal ctermfg=15 ctermbg=233 guifg=#ffffff guibg=#222222
...
highlight LineNr ctermbg=233 ctermfg=147 guifg=#2B2B2B guibg=#C0C0FF
